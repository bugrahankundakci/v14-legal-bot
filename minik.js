const { Client, GatewayIntentBits, ActionRowBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, ButtonBuilder, ChannelType, PermissionFlagsBits } = require('discord.js');
...
client
    ...
    // ÖZEL ODA SİSTEMİ
    const db = minik.db = new JsonDatabase({databasePath:"./src/database/minik_database.json"});
